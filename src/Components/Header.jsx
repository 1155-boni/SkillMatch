      ...
      <div className="flex flex-1 justify-end gap-8">
        ...
        {isLoggedIn ? (
          <button
            ...
            className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-[#ff4444] text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#cc0000] transition-colors"
          >
