    ...
    <div className="relative flex size-full min-h-screen flex-col bg-white group/design-root overflow-x-hidden" style={{ fontFamily: '"Work Sans", "Noto Sans", sans-serif' }}>
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f1f2f4] px-10 py-3">
        <div className="flex items-center gap-4 text-[#121416]">
          ...
          <h2 className="text-[#121416] text-lg font-bold leading-tight tracking-[-0.015em]">SkillMatch</h2>
        </div>
      ...
      <main className="flex flex-1 items-center justify-center px-10 py-16 bg-gradient-to-b from-white to-[#f1f2f4]">
        <div className="text-center max-w-4xl">
          <h1 className="text-[#121416] text-5xl font-bold leading-tight tracking-[-0.015em] mb-6">Connect Talent with Opportunity</h1>
      ...
      <section className="px-10 py-16 bg-white">
        <h2 className="text-[#121416] text-3xl font-bold text-center mb-12">Why Choose SkillMatch?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="p-6 bg-[#f1f2f4] rounded-xl text-center">
            <h3 className="text-[#121416] text-xl font-semibold mb-4">Showcase Skills</h3>
            <p className="text-[#6a7581] text-base">Create a professional profile and upload your portfolio to stand out to employers.</p>
          </div>
          <div className="p-6 bg-[#f1f2f4] rounded-xl text-center">
            <h3 className="text-[#121416] text-xl font-semibold mb-4">Find Microjobs</h3>
            <p className="text-[#6a7581] text-base">Browse and apply for short-term gigs tailored to your skills and schedule.</p>
          </div>
          <div className="p-6 bg-[#f1f2f4] rounded-xl text-center">
            <h3 className="text-[#121416] text-xl font-semibold mb-4">Build Your Portfolio</h3>
            <p className="text-[#6a7581] text-base">Gain real-world experience and showcase completed projects to future employers.</p>
          </div>
        </div>
      </section>

      <section className="px-10 py-16 bg-[#f1f2f4]">
        <h2 className="text-[#121416] text-3xl font-bold text-center mb-12">What Our Users Say</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <div className="p-6 bg-white rounded-xl shadow-md">
            <p className="text-[#6a7581] text-base italic mb-4">"SkillMatch helped me land my first freelance design gig—amazing platform!"</p>
            <p className="text-[#121416] font-semibold">- Jane Hope, Design Student</p>
          </div>
          <div className="p-6 bg-white rounded-xl shadow-md">
            <p className="text-[#6a7581] text-base italic mb-4">"Found a reliable coder for my startup project in just a day—highly recommend!"</p>
            <p className="text-[#121416] font-semibold">- John Nganga, Small Business Owner</p>
          </div>
        </div>
      </section>

      <section className="px-10 py-16 bg-[#c9daec] text-center">
        <h2 className="text-[#121416] text-3xl font-bold mb-6">Ready to Get Started?</h2>
        {isSignedIn ? (
          <p className="text-[#6a7581] text-lg mb-8">
            You're all set, {userData.username}! Start exploring jobs or manage your profile.
          </p>
        ) : (
          <>
            <p className="text-[#6a7581] text-lg mb-8">Join SkillMatch today and unlock your potential or find the talent you need.</p>
